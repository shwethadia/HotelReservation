...
func (m *postgresDBRepo) InsertReservation(res models.Reservation) (int, error) {
	...
	stmt := `insert into reservations (first_name,last_name,email,phone,start_date,end_date,room_id,created_at,
...
//SearchAvailabilityByRoomID returns true if availability exists and false no availability exist
...
//getReservationByID returns the reservation by user ID
